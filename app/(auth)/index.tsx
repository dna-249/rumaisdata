...
export default function Login() {
  ...
  const handleVerify = async() => {
    await axios.post(`https://dnadata.vercel.app/user/verify`,{
      ...
      password:password.trim().toLowerCase(),
      header:token
    }).then(res =>{  window.location.href = "https://annurdata.vercel.app";setUsers(()=>res.data);set(res.data._id);setText("Verification successfully");setVisible(true) ;nav.push({pathname: '/home',params:{id: res.data._id } });setLoading(false); console.log(res.data); })
