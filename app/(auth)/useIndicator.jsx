...
const useIndicator = () => {
  ...
  const snackbar =()=>{return(<Snackbar style={{alignSelf:"center",color:'white', fontSize:"large",justifyContent:"center", marginTop:0}} visible={visible} onDismiss={() => setVisible(false)}>{text} </Snackbar>)}
