...
const useIndicator = () => {
  ...
  const snackbar =()=>{return(<Snackbar style={{ display:"flex", position:"absolute", top:"10px", alignSelf:"center",color:'white', fontSize:"large",justifyContent:"center"}} visible={visible} onDismiss={() => setVisible(false)}>{text} </Snackbar>)}
